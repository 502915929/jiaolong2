...
public class ImageViewUtil extends ImageView {
    ...
    public ImageViewUtil(Context context) { this(context,null);
    }

    public ImageViewUtil(Context context, AttributeSet attrs) { this(context, attrs,0);
    }

    public ImageViewUtil(Context context, AttributeSet attrs, int defStyle) { super(context, attrs, defStyle);
        paint = new Paint();

    }

    /** * 绘制圆形图片
     * @author caizhiming */ @Override
